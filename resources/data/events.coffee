...
'''
    startTime: new Date(2019, 7, 10, 0, 0, 0)
    endTime: new Date(2019, 7, 11, 0, 0, 0)
    address:
      locality: 'Dillon'
      administrativeArea: 'CO'
    prices:
...
'''
    startTime: new Date(2019, 8, 7, 0, 0, 0)
    endTime: new Date(2019, 8, 8, 0, 0, 0)
    address:
      locality: 'Lake Tahoe'
      administrativeArea: 'CA'
    prices:
...
'''
    startTime: new Date(2019, 8, 13, 0, 0, 0)
    endTime: new Date(2019, 8, 15, 0, 0, 0)
    address:
      locality: 'Sisters'
      administrativeArea: 'OR'
    prices:
...
'''
    startTime: new Date(2019, 7, 29, 0, 0, 0)
    endTime: new Date(2019, 8, 2, 0, 0, 0)
    address:
      locality: 'La Pine'
      administrativeArea: 'OR'
...
'''
    startTime: new Date(2019, 7, 16, 0, 0, 0)
    endTime: new Date(2019, 7, 18, 0, 0, 0)
    address:
      locality: 'Taos'
...
'''
    startTime: new Date(2019, 9, 18, 0, 0, 0)
    endTime: new Date(2019, 9, 20, 0, 0, 0)
    address:
      locality: 'Mt Hermon'
...
This is an opportunity to bring your vehicle and circle up with fellow vanlifers for connection, conversation, and celebration for this entire weekend of van life community-building! Be sure to secure a spot for your vehicle for this camping festival on 65 acres of beautiful land located just 20 minutes from downtown Asheville!'''
    startTime: new Date(2019, 8, 20, 0, 0, 0)
    endTime: new Date(2019, 8, 22, 0, 0, 0)
    address:
      locality: 'Fletcher'
