...
amenities =
  ...
  'death-valley-inn-rv-park-dump-site':
    ...
    location: {lat: 36.904182, lon: -116.755623}
  ...
  'rv-pit-stop-quartzite':
    ...
    location: {lat: 33.673578, lon: -114.216787}
  ...
  'dollar-general-quartzite':
    ...
    location: {lat: 33.663178, lon: -114.231280}
    amenities: ['groceries']
  ...
  'shell-bowie':
    ...
    location: {lat: 32.319150, lon: -109.452341}
    amenities: ['water', 'gas']
    prices:
      water: 0
  'safeway-wilcox':
  ...
  'the-cove-rv-resort': # not actually that close to saddle mountain
    ...
    location: {lat: 33.603618, lon: -114.534739}
  ...
  'belly-acres-rv-park':
    ...
    location: {lat: 32.394032, lon: -112.871314}
  ...
  'family-dollar-ajo':
    ...
    location: {lat: 32.376560, lon: -112.873419}
    amenities: ['groceries']

  'shell-ajo':
    name: 'Shell Ajo'
    id: 'c66ffa60-ba1f-11e8-9d1e-e2d3dce10855'
    location: {lat: 32.375106, lon: -112.872631}
  ...
  'crazy-horse-rv-campgrounds':
    ...
    location: {lat: 34.469368, lon: -114.357193}
    amenities: ['dump', 'water']
    prices:
      dump: 5
      water: 5
  ...
  'walmart-yuma':
    ...
    location: {lat: 32.712408, lon: -114.652506}
    amenities: ['groceries', 'trash']

  'amerigas-yuma':
    name: 'AmeriGas Yuma'
    id: 'e6c0c3c0-bac0-11e8-863a-466d77a49d19'
    location: {lat: 32.698859, lon: -114.595986}
    amenities: ['propane']
  ...
  'ramco-julian':
    ...
    location: {lat: 33.076734, lon: -116.600245}
    amenities: ['propane', 'gas']
    # accessibility:
    #   gas: 2
    #   diesel: 2
  ...
  'chevron-chiriaco-summit':
    ...
    location: {lat: 33.660847, lon: -115.720135}
  ...
  'cottonwood-visitor-center':
    ...
    location: {lat: 33.748603, lon: -115.823964}
    amenities: ['dump', 'water']
    prices:
      water: 5
      dump: 5
  ...
  'winco-foods-indio':
    ...
    location: {lat: 33.739575, lon: -116.213104}
    amenities: ['groceries', 'trash']
  ...
  'borrego-palm-canyon-campground':
    ...
    location: {lat: 33.268828, lon: -116.406102}
    amenities: ['dump', 'water']

  'center-market':
    name: 'Center Market'
    id: '03f8f1b0-c395-11e8-ac96-09a7af40156c'
    location: {lat: 33.257449, lon: -116.379964}
    amenities: ['groceries']
