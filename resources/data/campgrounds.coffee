...
campgrounds =
  'snyder-hill-blm':
    ...
    location: {lat: 32.158132, lon: -111.115281}
    address:
      locality: 'Tucson'
  ...
  'saddle-mountain-blm':
    ...
    location: {lat: 33.464512, lon: -113.036644}
    address:
      locality: 'Tonopah'
      administrativeArea: 'AZ'
    siteCount:
  ...
  'scaddan-wash-blm':
    ...
    location: {lat: 33.661132, lon: -114.186548}
    address:
      locality: 'Quartzsite'
      administrativeArea: 'AZ'
    drivingInstructions: ''
  ...
  #   location: {lat: 31.860536, lon: -110.015574}
  #   address:
  #     locality: 'Tombstone'
  #     administrativeArea: 'AZ'
  #   siteCount:
  ...
  'darby-well-road':
    ...
    location: {lat: 32.339270, lon: -112.849561}
    address:
      locality: 'Ajo'
      administrativeArea: 'AZ'
    siteCount:
  ...
  'craggy-wash-blm':
    ...
    location: {lat: 34.586301, lon: -114.367222}
    address:
  ...
  'indian-bread-rocks-blm':
    ...
    location: {lat: 32.238663, lon: -109.499735}
    address:
      locality: 'Bowie'
      administrativeArea: 'AZ'
  ...
  'bombos-pond':
    ...
    location: {lat: 36.881623, lon: -116.753584}
    address:
      locality: 'Beatty'
  ...
  'american-girl-mine-blm':
    ...
    location: {lat: 32.836784, lon: -114.812061}
    address:
      locality: 'Obregon'
  ...
  'blair-valley':
    ...
    location: {lat: 33.037322, lon: -116.410416}
    address:
      locality: 'Julian'
      administrativeArea: 'CA'
    # # drivingInstructions: ''
  ...
  'joshua-tree-blm-south':
    ...
    location: {lat: 33.674494, lon: -115.801903}
    address:
  ...
  #   location: {lat: 36.133394, lon: -114.837833}
  #   address:
  #     locality: 'Las Vegas'
  #     administrativeArea: 'NV'
  #   # # # drivingInstructions: ''
  ...
  'rockhouse':
    ...
    location: {lat: 33.294480, lon: -116.290165}
    address:
