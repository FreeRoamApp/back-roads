...
class CacheService
  ...
  PREFIXES:
    ...
    GROUP_ROLE_GROUP_UUID_USER_UUID: 'group_role:groupUuid:userUuid3'
    GROUP_ROLES: 'group_role:groupUuid1'
    GROUP_USER_USER_UUID: 'group_user:user_id10'
    ...
    THREAD_BY_UUID: 'thread:uuid'
    THREAD_WITH_EMBEDS_BY_ID: 'thread:with_embeds:id2'
    THREAD_WITH_EMBEDS_BY_UUID: 'thread:with_embeds:uuid'
